...
?>
    ...
    <div class="card">
        <div class="card-body">
            <h5><i class="bi bi-briefcase"></i> Registro de coberturas</h5>
        </div>
    </div>
    </br>
    <div class="card">
                ...
                <div class="col-md-5 centralizarDiv">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-primary" id="pesquisar" onclick="carregarServico('')">
                            <i class="bi bi-search"></i> Pesquisar cobertura
                        </button>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalServico" data-bs-whatever="Novo cobertura">
                            <i class="bi bi-plus-square-dotted"></i> Novo cobertura
                        </button>
    ...
    <!-- Começo - Modal com os dados cobertura-->
    <div class="modal fade" id="modalServico" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Dados do cobertura</h1>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <label for="nomeServico" class="col-form-label">Nome do cobertura:</label>
    ...
    <!-- Fim - Modal com os dados cobertura-->
